...
DIFFUSION_MODEL = "ByteDance-Seed/BAGEL-7B-MoT"
DIFFUSION_MULTI_REPLICA_DEPLOY = get_deploy_config_path("ci/bagel_multi_replicas_4gpu.yaml")
...
diffusion_test_params = [
    OmniServerParams(
        model=DIFFUSION_MODEL,
        stage_config_path=DIFFUSION_MULTI_REPLICA_DEPLOY,
        server_args=["--disable-log-stats"],
        use_stage_cli=True,
    )
]
...
@hardware_test(res={"cuda": "H100"}, num_cards=4)
@pytest.mark.parametrize("omni_server", diffusion_test_params, indirect=True)
