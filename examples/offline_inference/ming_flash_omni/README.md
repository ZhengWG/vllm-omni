...
|------|-------------|--------|
| Thinker only (multimodal understanding) | default `--omni` (no extra config) | Text |
| Thinker + Talker (omni-speech) | `vllm_omni/model_executor/stage_configs/ming_flash_omni.yaml` | Text + Audio |
